...
<body>
  ...
  <form>
    ...
    <p>
      ...
      <button type="button" onclick="window.location.href='https://aidenk1.github.io/blackjack/signup'" class="button-spacing">Sign Up</button>
    </p>
  </form>
    ...
    async function login_api(uid, password) { 
      ...
      try {
        ...
        if (response.ok) {
          ...
          window.location.href = "https://aidenk1.github.io/blackjack/homepage"; // Redirecting to homepage
        } else {
